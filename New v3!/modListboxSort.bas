...
'This Module was found at: http://www.sourceforge.net

'I had this lying around and figured it would be useful
'to sort the listbox alphabetically and that's what this does.

'I take no credit for anything in this module.
